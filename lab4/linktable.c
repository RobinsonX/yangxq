...
tLinkTableNode *GetLinkTableHead(tLinkTabl *pLinkTable)
{
	if(pLinkTable == NULL || pLinkTablee -> pHead == NULL)
	{
			return NULL;
	}
...
tLinkTalbeNode *GetNextLinkTableNode(tLinkTable *pLinkTable, tLinkTableNode *pNode)
{
